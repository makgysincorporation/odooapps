odoo.define('mi_website_form_email_validation.website_form_error_inherit', function (require) {
    'use strict';
        ...
        publicWidget.registry.website_crm_form_email_validation = publicWidget.Widget.extend({
            ...
            start: function (editable_mode) {
                ...
                this.templates_loaded_extra = ajax.loadXML('/mi_website_crm_email_validation/static/src/xml/website_crm_email_message.xml', qweb);
            ...
            is_email_valid: function (value) {
                    var re =  /(^\w.*@\w+\.\w)/;
                    var value=re.test(value);
                    if(value){
                    ...
                    var self = this;
                        ...
                        self.update_status('invalid_email');
                        return false
                    }
            ...
            check_error_fields: function (error_fields) {
                ...
                this.$target.find('.form-field').each(function (k, field){
                    ...
                    var invalid_inputs = inputs.toArray().filter(function (input, k, inputs) {
                        ...
                        } else if ($(input).hasClass('email-validation')){ 
                            if (!self.is_email_valid(input.value)) {
            ...
            update_status: function (status) {
                ...
                this.templates_loaded.then(function () {
                 ...
                 this.templates_loaded_extra.then(function () {
                    $result.replaceWith(qweb.render("mi_website_crm_email_validation.status_" + status));
                });
                 }
        ...
        return publicWidget.registry.website_crm_form_email_validation
    });
